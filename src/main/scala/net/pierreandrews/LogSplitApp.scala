...
object LogSplitApp extends ArgMain[LogSplitAppArgs] {
  ...
  override def main(args: LogSplitAppArgs): Unit = {
    ...
    // as defined by [HOCON](https://github.com/typesafehub/config/blob/master/HOCON.md)
...
/**
  * # Command line argument definition, using [Sumac](https://github.com/quantifind/Sumac).
 *
